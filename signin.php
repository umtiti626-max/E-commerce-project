...
<head>
    ...
    <style>
        ...
        /* Fly-in animation for the sign-up container */
        .flyin-entry {
            opacity: 0;
            transform: translateY(60px) scale(0.98);
            animation: flyinFadeIn 0.85s cubic-bezier(.23,1.02,.32,1) 0.1s forwards;
...
<body>
    <div class="login-container" id="signupContainer">
    ...
    <script>
    // Add fly-in effect on page load
    document.addEventListener('DOMContentLoaded', function() {
        const container = document.getElementById('signupContainer');
        if (container) {
            container.classList.add('flyin-entry');
        }
    });
